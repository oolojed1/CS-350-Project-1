...
00000160 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     169:	68 b5 12 00 00       	push   $0x12b5
     16e:	6a 02                	push   $0x2
...
00000180 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     199:	ff 24 85 d0 12 00 00 	jmp    *0x12d0(,%eax,4)
    if(pipe(p) < 0)
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 e0 18 00 00       	push   $0x18e0
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 e0 18 00 00       	push   $0x18e0
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     546:	50                   	push   %eax
     547:	68 d8 18 00 00       	push   $0x18d8
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     565:	50                   	push   %eax
     566:	68 e0 18 00 00       	push   $0x18e0
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 e0 18 00 00       	push   $0x18e0
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     673:	68 69 12 00 00       	push   $0x1269
     678:	53                   	push   %ebx
     679:	56                   	push   %esi
  ...
  return cmd;
     ...
     6fe:	68 4c 12 00 00       	push   $0x124c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     71f:	68 6c 12 00 00       	push   $0x126c
     724:	57                   	push   %edi
     725:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     76e:	68 83 12 00 00       	push   $0x1283
     773:	57                   	push   %edi
     774:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     7b8:	68 75 12 00 00       	push   $0x1275
  ...
  cmd->eargv[argc] = 0;
     ...
     80a:	68 6e 12 00 00       	push   $0x126e
...
00000820 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     839:	68 88 12 00 00       	push   $0x1288
  cmd = parseexec(ps, es);
...
00000890 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     8cb:	68 8a 12 00 00       	push   $0x128a
     8d0:	56                   	push   %esi
     8d1:	53                   	push   %ebx
  ...
  if(peek(ps, es, ";")){
     ...
     8e1:	68 86 12 00 00       	push   $0x1286
     8e6:	56                   	push   %esi
     8e7:	53                   	push   %ebx
...
00000930 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     93f:	68 6c 12 00 00       	push   $0x126c
     944:	56                   	push   %esi
     945:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     969:	68 a8 12 00 00       	push   $0x12a8
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     9d5:	ff 24 85 e8 12 00 00 	jmp    *0x12e8(,%eax,4)
...
00000a70 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a97:	68 31 12 00 00       	push   $0x1231
     a9c:	53                   	push   %ebx
     a9d:	50                   	push   %eax
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     abf:	52                   	push   %edx
     ac0:	50                   	push   %eax
     ac1:	68 aa 12 00 00       	push   $0x12aa
     ac6:	6a 02                	push   $0x2
     ac8:	e8 e3 03 00 00       	call   eb0 <printf>
    panic("syntax");
     acd:	c7 04 24 6e 12 00 00 	movl   $0x126e,(%esp)
     ...
     df6:	89 d3                	mov    %edx,%ebx
{
  ...
  do{
    ...
    buf[i++] = digits[x % base];
     ...
     e39:	0f b6 92 08 13 00 00 	movzbl 0x1308(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     e7e:	56                   	push   %esi
     e7f:	57                   	push   %edi
     e80:	e8 cc fe ff ff       	call   d51 <write>
...
printf(int fd, char *fmt, ...)
{
  ...
  write(fd, &c, 1);
     ...
     ef9:	e8 53 fe ff ff       	call   d51 <write>
  ...
  write(fd, &c, 1);
     ...
     f5a:	e8 f2 fd ff ff       	call   d51 <write>
        putc(fd, c);
      } else {
  ...
  write(fd, &c, 1);
     ...
     f6e:	e8 de fd ff ff       	call   d51 <write>
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
     fe4:	e8 68 fd ff ff       	call   d51 <write>
        ap++;
  ...
  write(fd, &c, 1);
    ...
    105b:	57                   	push   %edi
    105c:	53                   	push   %ebx
    105d:	e8 ef fc ff ff       	call   d51 <write>
        while(*s != 0){
...
malloc(uint nbytes)
{
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1138:	39 f1                	cmp    %esi,%ecx
    113a:	73 72                	jae    11ae <malloc+0x9e>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    117b:	e8 39 fc ff ff       	call   db9 <sbrk>
  if(p == (char*)-1)
