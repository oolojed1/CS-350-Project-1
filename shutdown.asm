...
main(int argc, char * argv[])
{
   ...
   e:	83 ec 0c             	sub    $0xc,%esp
    printf(1, "BYE~\n");
  11:	68 68 07 00 00       	push   $0x768
  16:	6a 01                	push   $0x1
  18:	e8 e3 03 00 00       	call   400 <printf>
    shutdown();
  1d:	e8 ff 02 00 00       	call   321 <shutdown>
    exit(); //return 0;
  22:	e8 5a 02 00 00       	call   281 <exit>
  27:	66 90                	xchg   %ax,%ax
  29:	66 90                	xchg   %ax,%ax
  2b:	66 90                	xchg   %ax,%ax
  2d:	66 90                	xchg   %ax,%ax
...
printf(int fd, char *fmt, ...)
{
 ...
 584:	eb 1a                	jmp    5a0 <printf+0x1a0>
          s = "(null)";
 586:	bb 6e 07 00 00       	mov    $0x76e,%ebx
        while(*s != 0){
 ...
 5f6:	73 10                	jae    608 <free+0x38>
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	a3 20 0a 00 00       	mov    %eax,0xa20
}
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 629:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 20 0a 00 00    	mov    0xa20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	8b 3d 20 0a 00 00    	mov    0xa20,%edi
 ...
 6e2:	e8 e9 fe ff ff       	call   5d0 <free>
  return freep;
 6e7:	8b 15 20 0a 00 00    	mov    0xa20,%edx
 ...
 714:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 717:	89 15 20 0a 00 00    	mov    %edx,0xa20
}
 ...
 72f:	90                   	nop
    base.s.ptr = freep = prevp = &base;
 730:	c7 05 20 0a 00 00 24 	movl   $0xa24,0xa20
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 24 0a 00 00       	mov    $0xa24,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 24 0a 00 00 24 	movl   $0xa24,0xa24
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 74b:	c7 05 28 0a 00 00 00 	movl   $0x0,0xa28
 752:	00 00 00 
    if(p->s.size >= nunits){
